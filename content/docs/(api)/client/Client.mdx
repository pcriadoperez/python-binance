...
<PyFunction name={"__init__"} type={"(self, api_key=None, api_secret=None, requests_params=None, tld='com', base_endpoint=BaseClient.BASE_ENDPOINT_DEFAULT, testnet=False, private_key=None, private_key_pass=None, ping=True, time_unit=None)"}>
...
<PyParameter name={"ping"} type={"Optional[bool]"} value={"True"} />
...
<PyFunction name={"_init_session"} type={"(self) -> requests.Session"}>
...
<PyFunctionReturn type={"requests.requests.Session"} />
...
<PyFunction name={"_handle_response"} type={"(response)"}>
...
<PyParameter name={"response"} type={"requests.Response"} value={null} />
...
<PyParameter name={"signed"} type={"bool"} value={"False"} />
...
<PyFunction name={"get_all_tickers"} type={"(self) -> List[Dict[str, str]]"}>
...
<PyFunction name={"get_historical_klines_generator"} type={"(self, symbol, interval, start_str=None, end_str=None, limit=None, klines_type=HistoricalKlinesType.SPOT)"}>
...
<PyFunction name={"_historical_klines_generator"} type={"(self, symbol, interval, start_str=None, end_str=None, limit=None, klines_type=HistoricalKlinesType.SPOT)"}>
...
<PyFunction name={"get_account_status"} type={"(self, version=1, **params)"}>
...
<PyFunction name={"get_isolated_margin_tranfer_history"} type={"(self, **params)"}>
...
<PyFunction name={"futures_continous_klines"} type={"(self, **params)"}>
...
<PyFunction name={"futures_historical_klines"} type={"(self, symbol, interval, start_str, end_str=None, limit=500)"}>
...
<PyFunction name={"futures_historical_mark_price_klines"} type={"(self, symbol, interval, start_str, end_str=None, limit=500)"}>
...
<PyFunction name={"futures_coin_accout_order_history_download_link"} type={"(self, **params)"}>
...
<PyFunction name={"__del__"} type={"(self)"}>
