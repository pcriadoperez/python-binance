...
<PyAttribute name={"STREAM_TESTNET_URL"} type={null} value={"'wss://testnet.binance.vision/'"} />
...
<PyAttribute name={"VSTREAM_URL"} type={null} value={"self.VSTREAM_URL.format(client.tld)"} />

<PyAttribute name={"VSTREAM_TESTNET_URL"} type={null} value={"self.VSTREAM_TESTNET_URL.format(client.tld)"} />
...
<PyFunction name={"__init__"} type={"(self, client, user_timeout=KEEPALIVE_TIMEOUT)"}>
