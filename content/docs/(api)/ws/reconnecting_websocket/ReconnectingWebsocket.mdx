...
<PyAttribute name={"MAX_QUEUE_SIZE"} type={null} value={"100"} />
...
<PyFunction name={"__init__"} type={"(self, url, path=None, prefix='ws/', is_binary=False, exit_coro=None, https_proxy=None, **kwargs)"}>
...
<PyFunction name={"json_dumps"} type={"(self, msg)"}>
