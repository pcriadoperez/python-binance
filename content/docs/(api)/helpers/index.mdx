...
<PyFunction name={"date_to_milliseconds"} type={"(date_str) -> int"}>
...
<PyParameter name={"date_str"} type={"str"} value={null} />
...
<PyFunction name={"interval_to_milliseconds"} type={"(interval) -> Optional[int]"}>
...
<PyFunctionReturn type={"typing.Optional[int]"} />

</PyFunction>
<PyFunction name={"round_step_size"} type={"(quantity, step_size) -> float"}>
...
<PyParameter name={"quantity"} type={"Union[float, Decimal]"} value={null} />
<PyParameter name={"step_size"} type={"Union[float, Decimal]"} value={null} />
...
<PyFunction name={"convert_ts_str"} type={"(ts_str)"}>
...
<PyParameter name={"ts_str"} type={null} value={null} />
...
<PyFunction name={"convert_list_to_json_array"} type={"(l)"}>
...
<PyParameter name={"l"} type={null} value={null} />
